                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <?php if ( $countRow != 1 ) :?>
                                                        <a onclick="return confirm('Are your sure delete it ?')" href="sql/deleteItemBill.php?id=<?= $row['id'] ?>&pro_id=<?= $row['product_id'] ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></a>
                                                    <?php else :?>
