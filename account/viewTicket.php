...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 mx-auto">
                            <div class="mt-1">
                                <button onclick="printpage()" class="btn btn-danger"><i class="fa fa-print" aria-hidden="true"></i></button>
                            </div>
                            <div class="card mt-2 p-2">
                                <div class="card-header bg-dark">
                                    <h3 class="text-center">บิลขาย</h3>
                                </div>
                                <div class="card-body">
    ...
    <script> 
        function printpage() {
            window.location = 'print/printBill.php?id='+ <?= $row['id'] ?> ;
        }
    </script>
